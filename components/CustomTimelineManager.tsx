              ...
              <div>
                ...
                <div className="grid grid-cols-8 gap-2 border border-gray-200 rounded p-2">
                  {PREFECTURES.map(pref => {
                    const selected = formData.selectedPrefectures.includes(pref.code);
                    return (
                      <button
                        type="button"
                        key={pref.code}
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-500">
                          {PREFECTURES.find(p => p.code === politician.prefecture)?.name} - {POSITION_LABELS[politician.position as keyof typeof POSITION_LABELS]}
                        </div>
                      </div>
                    </button>
